...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { close: @quotation.close, code: @quotation.code, high: @quotation.high, low: @quotation.low, name: @quotation.name, open: @quotation.open, plate: @quotation.plate }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { close: @quotation.close, code: @quotation.code, high: @quotation.high, low: @quotation.low, name: @quotation.name, open: @quotation.open, plate: @quotation.plate }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
